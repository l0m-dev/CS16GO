...
void EXT_FUNC CBasePlayer::__API_HOOK(PostThink)()
{
	...
	{
			switch (RANDOM_LONG(0, 3)) {
			case 0: EMIT_SOUND(ENT(pev), CHAN_BODY, "misc/land1.wav", VOL_NORM, ATTN_NORM); break;
			case 1: EMIT_SOUND(ENT(pev), CHAN_BODY, "misc/land2.wav", VOL_NORM, ATTN_NORM); break;
			case 2: EMIT_SOUND(ENT(pev), CHAN_BODY, "misc/land3.wav", VOL_NORM, ATTN_NORM); break;
			case 3: EMIT_SOUND(ENT(pev), CHAN_BODY, "misc/land4.wav", VOL_NORM, ATTN_NORM); break;
			}

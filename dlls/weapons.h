...
public:
	...
	void Explode(TraceResult *pacc, int bitsDamageType);
...
const float USP_MAX_SPEED     = 240.0f;
const float USP_DAMAGE        = 35.0f;
const float USP_DAMAGE_SIL    = 35.0f;
const float USP_RANGE_MODIFER = 0.91f;
const float USP_RELOAD_TIME   = 2.2f;
...
const float MP5N_MAX_SPEED     = 235.0f;
const float MP5N_DAMAGE        = 27.0f;
const float MP5N_RANGE_MODIFER = 0.85f;
const float MP5N_RELOAD_TIME   = 2.97f;
...
const float SG552_MAX_SPEED      = 210.0f;
const float SG552_MAX_SPEED_ZOOM = 150.0f;
const float SG552_DAMAGE         = 30.0f;
const float SG552_RANGE_MODIFER  = 0.98f;
const float SG552_RELOAD_TIME    = 2.8f;
...
const float AK47_RELOAD_TIME   = 2.5f;
...
const float AUG_MAX_SPEED     = 221.0f;
const float AUG_DAMAGE        = 28.0f;
const float AUG_RANGE_MODIFER = 0.98f;
const float AUG_RELOAD_TIME   = 3.8f;
...
const float AWP_MAX_SPEED      = 200.0f;
const float AWP_MAX_SPEED_ZOOM = 100.0f;
const float AWP_DAMAGE         = 115.0f;
const float AWP_RANGE_MODIFER  = 0.99f;
const float AWP_RELOAD_TIME    = 3.7f;
...
const float DEAGLE_MAX_SPEED     = 230.0f;
const float DEAGLE_DAMAGE        = 63.0f;
...
const float FLASHBANG_MAX_SPEED        = 245.0f;
...
const float G3SG1_MAX_SPEED      = 215.0f;
const float G3SG1_MAX_SPEED_ZOOM = 120.0f;
const float G3SG1_DAMAGE         = 80.0f;
const float G3SG1_RANGE_MODIFER  = 0.98f;
const float G3SG1_RELOAD_TIME    = 4.7f;
...
const float GLOCK18_MAX_SPEED     = 240.0f;
const float GLOCK18_DAMAGE        = 30.0f;
const float GLOCK18_RANGE_MODIFER = 0.85f;
...
const float HEGRENADE_MAX_SPEED        = 245.0f;
...
const float M249_MAX_SPEED     = 195.0f;
const float M249_DAMAGE        = 32.0f;
const float M249_RANGE_MODIFER = 0.97f;
const float M249_RELOAD_TIME   = 5.7f;
...
const float M3_MAX_SPEED   = 220.0f;
...
const float M4A1_MAX_SPEED         = 225.0f;
const float M4A1_DAMAGE            = 33.0f;
const float M4A1_DAMAGE_SIL        = 33.0f;
const float M4A1_RANGE_MODIFER     = 0.99f;
const float M4A1_RANGE_MODIFER_SIL = 0.99f;
const float M4A1_RELOAD_TIME       = 3.1f;
...
const float MAC10_MAX_SPEED     = 240.0f;
const float MAC10_DAMAGE        = 29.0f;
const float MAC10_RANGE_MODIFER = 0.82f;
const float MAC10_RELOAD_TIME   = 2.6f;
...
const float P228_MAX_SPEED     = 240.0f;
const float P228_DAMAGE        = 35.0f;
const float P228_RANGE_MODIFER = 0.91f;
const float P228_RELOAD_TIME   = 2.2f;
...
const float P90_MAX_SPEED     = 230.0f;
const float P90_DAMAGE        = 26.0f;
const float P90_RANGE_MODIFER = 0.86f;
const float P90_RELOAD_TIME   = 3.3f;
...
const float SCOUT_MAX_SPEED      = 230.0f;
const float SCOUT_MAX_SPEED_ZOOM = 230.0f;
const float SCOUT_DAMAGE         = 88.0f;
const float SCOUT_RANGE_MODIFER  = 0.98f;
const float SCOUT_RELOAD_TIME    = 3.7f;
...
const float SMOKEGRENADE_MAX_SPEED        = 245.0f;
...
const float TMP_MAX_SPEED     = 240.0f;
const float TMP_DAMAGE        = 26.0f;
const float TMP_RANGE_MODIFER = 0.87f;
const float TMP_RELOAD_TIME   = 2.10f;
...
const float ELITE_MAX_SPEED     = 240.0f;
const float ELITE_RELOAD_TIME   = 3.8f;
const float ELITE_DAMAGE        = 38.0f;
const float ELITE_RANGE_MODIFER = 0.79f;
...
const float FIVESEVEN_MAX_SPEED     = 240.0f;
const float FIVESEVEN_DAMAGE        = 32.0f;
const float FIVESEVEN_RANGE_MODIFER = 0.885f;
const float FIVESEVEN_RELOAD_TIME   = 2.2f;
...
const float UMP45_MAX_SPEED     = 230.0f;
const float UMP45_DAMAGE        = 35.0f;
const float UMP45_RANGE_MODIFER = 0.75f;
...
const float SG550_MAX_SPEED      = 215.0f;
const float SG550_MAX_SPEED_ZOOM = 120.0f;
const float SG550_DAMAGE         = 80.0f;
const float SG550_RANGE_MODIFER  = 0.98f;
const float SG550_RELOAD_TIME    = 3.1f;
...
const float GALIL_MAX_SPEED     = 215.0f;
const float GALIL_DAMAGE        = 30.0f;
const float GALIL_RANGE_MODIFER = 0.98f;
const float GALIL_RELOAD_TIME   = 3.0f;
...
const float FAMAS_MAX_SPEED     = 220.0f;
